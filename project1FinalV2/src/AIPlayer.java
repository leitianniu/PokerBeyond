/*Adrian Campos
  ...
  tlei2@uic.edu
   ...
   AIPlayer:
   Handles all AI functions and prints AI_hand.
   
   AI players discard cards based on certain rules.
   This class takes care of that in the discard_card method.
 */
...
public class AIPlayer{
	...
	//AI Algorithm for discarding. Checks multiple cases as specified by the writeup
	public static void discard_draw(List<Card> ai_hand, CardPile deck, CardPile discardpile, int compnum){
		...
		//Depending on the AI hand, discard card accordingly:
	...
	//helper function for four flush case discard.
